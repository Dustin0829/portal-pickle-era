...
| `@commit-changes`                                    | commit my changes (repo root [`.cursor/skills/commit-changes`](../../.cursor/skills/commit-changes/SKILL.md))           |
| `@create-pull-request`                               | open PR to `main` (repo root [`.cursor/skills/create-pull-request`](../../.cursor/skills/create-pull-request/SKILL.md)) |
| `@merge-readiness-check`                             | ready to merge?                                                                                                         |

PR body uses the repository root `create-pull-request` skill (not Cursor's global PR format).
...
| `state/`    | `error-handling`, `data-ownership`, `react-state-zustand`, `async-ui`, `offline-reconnect`            |
