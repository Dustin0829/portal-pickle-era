...
**Prerequisites:**
- **`/opsx-verify` passed** for code changes (or user explicitly skipped with confirmation)
- **`/opsx-pr` completed** or a PR already open for this change
- User selected this change to archive
