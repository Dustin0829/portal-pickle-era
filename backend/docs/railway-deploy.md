...
| `PUBLIC_APP_URL`                                                                        | SPA origin for invite/login/reset links **and** email logo (`{PUBLIC_APP_URL}/logo.png` from `app/public/logo.png`); falls back to first `API_CORS_ORIGIN` when unset |
